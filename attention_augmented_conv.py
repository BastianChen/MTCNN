...
class AugmentedConv(nn.Module):
    ...
    def relative_logits_1d(self, q, rel_k, H, W, Nh, case):
        ...
        # rel_logits = torch.reshape(rel_logits, (-1, Nh * H, W,  W - 1))
...
# Example Code
# tmp = torch.randn((10, 3, 12, 12)).to(device)
# augmented_conv1 = AugmentedConv(in_channels=3, out_channels=10, kernel_size=3, dk=4, dv=4, Nh=2, relative=True,
#                                 stride=1, shape=12).to(device)
# conv_out1 = augmented_conv1(tmp)
# print(conv_out1.shape)
# param_num = sum([param.numel() for param in augmented_conv1.parameters()])
# print(param_num)

# for name, param in augmented_conv1.named_parameters():
#     print('parameter name: ', name)
#
# augmented_conv2 = AugmentedConv(in_channels=3, out_channels=20, kernel_size=3, dk=40, dv=4, Nh=4, relative=True,
#                                 stride=1, shape=32).to(device)
